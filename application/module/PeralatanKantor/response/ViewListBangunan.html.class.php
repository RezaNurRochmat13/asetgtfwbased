...
class ViewListBangunan extends HtmlResponse{
	...
	function ParseTemplate($data=NULL){
		$this->mrTemplate->Addvar('content', 'URL_ADD', Dispatcher::Instance()->GetUrl('Bangunan', 'AddBangunan', 'View', 'html'));
			if (is_array($data))
            extract($data);
        	if (!empty($message)) {
        ...
        if (!empty($data)) {
            ...
            foreach ($data as $val) {
				...
				$val['URL_UPDATE'] = Dispatcher::Instance()->GetUrl('Bangunan', 'UpdateBangunan', 'view', 'html').'&kodeAset='.Dispatcher::Instance()->Encrypt($val['KODE_ASET']);
				//delete
				$label = "Kendaraan";
				...
				$urlAccept = 'Bangunan|DeleteBangunan|do|json';
				$urlReturn = 'Bangunan|ListBangunan|view|html';
